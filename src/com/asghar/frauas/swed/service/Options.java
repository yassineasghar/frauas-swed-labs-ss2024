...
public class Options {
        ...
        while (true) {
            ...
            if (websiteInput.equalsIgnoreCase("done")) {
                if (hasAddedWebsite) {
                    ...
                    System.out.println("You must add at least one website before typing 'done'.");
                    continue;
                }
            }
            ...
            if (isValidWebsiteInput(websiteInput)) {
                ...
                System.out.println("Invalid website input: check for www ! " + websiteInput);
            }
        }
    }
    ...
    public static boolean isValidWebsiteInput(String input) {
        return input.contains("localhost:") || input.contains("www.");
    }
